...
export const GRAMMAR_CARDS = {
  noun: [
    ...
    { id: 'n02', name: '부정형', nameJp: '否定形', suffix: 'じゃない',
      conjugate: s => `${s}じゃない`, meaning: m => `${m}이/가 아니다` },
    { id: 'n03', name: '과거형', nameJp: '過去形', suffix: 'だった',
      conjugate: s => `${s}だった`, meaning: m => `${m}이었다` },
    { id: 'n04', name: '과거부정형', nameJp: '過去否定形', suffix: 'じゃなかった',
      conjugate: s => `${s}じゃなかった`, meaning: m => `${m}이/가 아니었다` },
    { id: 'n05', name: '정중형', nameJp: '丁寧形', suffix: 'です',
      conjugate: s => `${s}です`, meaning: m => `${m}입니다` },
    { id: 'n06', name: '정중부정형', nameJp: '丁寧否定形', suffix: 'じゃないです',
      conjugate: s => `${s}じゃないです`, meaning: m => `${m}이/가 아닙니다` },
    { id: 'n07', name: '과거정중형', nameJp: '過去丁寧形', suffix: 'でした',
      conjugate: s => `${s}でした`, meaning: m => `${m}이었습니다` },
    { id: 'n08', name: '과거정중부정형', nameJp: '過去丁寧否定形', suffix: 'じゃなかったです',
      conjugate: s => `${s}じゃなかったです`, meaning: m => `${m}이/가 아니었습니다` },
  ],
  'na-adj': [
    { id: 'na01', name: '기본형', nameJp: '基本形', suffix: 'だ',
      conjugate: s => `${s}だ`, meaning: m => `${m}` },
    { id: 'na02', name: '부정형', nameJp: '否定形', suffix: 'じゃない',
      conjugate: s => `${s}じゃない`, meaning: m => `${m.replace(/다$/, '지 않다')}` },
    { id: 'na03', name: '과거형', nameJp: '過去形', suffix: 'だった',
      conjugate: s => `${s}だった`, meaning: m => `${m.replace(/다$/, '했다')}` },
    { id: 'na04', name: '과거부정형', nameJp: '過去否定形', suffix: 'じゃなかった',
      conjugate: s => `${s}じゃなかった`, meaning: m => `${m.replace(/다$/, '지 않았다')}` },
    { id: 'na05', name: '정중형', nameJp: '丁寧形', suffix: 'です',
      conjugate: s => `${s}です`, meaning: m => `${m.replace(/다$/, '합니다')}` },
    { id: 'na06', name: '정중부정형', nameJp: '丁寧否定形', suffix: 'じゃないです',
      conjugate: s => `${s}じゃないです`, meaning: m => `${m.replace(/다$/, '지 않습니다')}` },
    { id: 'na07', name: '과거정중형', nameJp: '過去丁寧形', suffix: 'でした',
      conjugate: s => `${s}でした`, meaning: m => `${m.replace(/다$/, '했습니다')}` },
    { id: 'na08', name: '과거정중부정형', nameJp: '過去丁寧否定形', suffix: 'じゃなかったです',
      conjugate: s => `${s}じゃなかったです`, meaning: m => `${m.replace(/다$/, '지 않았습니다')}` },
